        ...
        <div class="center">
            <form id="pointadmin" action="" method="POST">
                ...
                <div id="pointadmintable">
                        <div>
                            <div class="col-md-6" style="text-align: left;"><?php if ($_POST['page'] != 1) { ?><button name="page" type="Submit" value="<?php echo ($_POST['page'] - 1); ?>" class="btn btn-default">Previous</button><?php } ?></div>
                            <div class="col-md-6" style="text-align: right;"><?php if ($rowcount > 49) { ?><button name="page" type="Submit" value="<?php echo ($_POST['page'] + 1); ?>" class="btn btn-default">Next</button><?php } ?></div>
                    </div>
