...
<form id="that-editor">
    ...
    <script>
        ...
        //CKEDITOR.instances.editor1.config.contentsCss = [ '/assets/css/font-awesome.css', '/assets/css/simplex-bootstrap.min.css.php', '/assets/css/style.css.php' ];
...
CKEDITOR.instances.editor1.config.contentsCss = ['/assets/css/font-awesome.css', '/assets/css/simplex-bootstrap.min.css.php', '/assets/css/style.css.php'].concat(myFonts);
